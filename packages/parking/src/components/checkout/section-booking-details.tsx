                ...
                <div className="flex flex-col gap-6 ">
                    <div className="flex justify-between items-center w-full">
                        <div className="flex items-center gap-2">
                            <Icon as={CalendarTick} size="24" className="text-foreground-600 stroke-current" />
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div className="flex items-center gap-2">
                            <Icon as={CalendarRemove} size="24" className="text-foreground-600 stroke-current" />
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div className="flex items-center gap-2">
                            <Icon as={Timer1} size="24" className="text-foreground-600 stroke-current" />
