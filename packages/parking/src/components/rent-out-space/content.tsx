...
import { ContentBackground } from "@/ui/content-background"
...
export const Content = () => {
    ...
    return <div className="flex w-full px-2">
        <ContentBackground type="dot" opacity={0.2} className="pb-16" hideGradient>
            ...
            <div className="h-full lg:px-6 z-10 w-full">
                <div className="flex flex-col w-full h-full md:mt-14 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-3 md:gap-6 z-10">
