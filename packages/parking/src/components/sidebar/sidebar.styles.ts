...
export const SidebarWrapperStyled = tv({
...
export const Footer = tv({
  base: 'flex items-center justify-center gap-6 pb-8 px-8 md:pb-0',
});

export const Sidebar = Object.assign(SidebarWrapperStyled, {
  Header,
  Body,
  Overlay,
  Footer,
